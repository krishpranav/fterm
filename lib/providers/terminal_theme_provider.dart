/**
 * @file terminal_theme_provider.dart
...
final themesProvider = FutureProvider<Map<String, TerminalTheme>>((ref) async {
  ...
  final themes = Map<String, TerminalTheme>.fromEntries(
    res.data?.map((json) {
          return MapEntry(json["name"], TerminalThemeJson.fromJson(json));
        }) ??
        [],
  );
  return {
